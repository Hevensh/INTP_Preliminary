...
NAME="deit_tiny_rot_hex_harmonic_softmax_pe_half7_compact_r5_imagenet100_ddp_e20"
...
echo "[run] 20 epochs | half7d5r + null-softmax | PE only | no differentiation | batch ${BATCH_SIZE}/GPU"
...
torchrun --standalone --nproc_per_node="${NPROC_PER_NODE}" \
  ...
  --config configs/imagenet100/deit_tiny_rot_hex_harmonic_softmax_pe_half7_compact_r5_ddp_e20.json \
