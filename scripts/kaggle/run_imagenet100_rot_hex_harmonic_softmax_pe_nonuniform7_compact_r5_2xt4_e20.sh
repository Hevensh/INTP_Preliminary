...
NAME="deit_tiny_rot_hex_harmonic_softmax_pe_nonuniform7_compact_r5_imagenet100_ddp_e20"
...
echo "[run] 20 epochs | nonuniform7d5r + null-softmax | PE only | no differentiation | batch ${BATCH_SIZE}/GPU"
echo "[poses] angles 0,-5,5,-15,15,-30,30 degrees | K24/K12 | 14 real poses + null"
torchrun --standalone --nproc_per_node="${NPROC_PER_NODE}" \
  -m experiments.imagenet100.train_vit \
  --config configs/imagenet100/deit_tiny_rot_hex_harmonic_softmax_pe_nonuniform7_compact_r5_ddp_e20.json \
