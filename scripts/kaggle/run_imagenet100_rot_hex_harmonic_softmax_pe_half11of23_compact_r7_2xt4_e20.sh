...
NAME="deit_tiny_rot_hex_harmonic_softmax_pe_half11of23_compact_r7_imagenet100_ddp_e20"
...
echo "[run] 20 epochs | 11of23d7r + null-softmax | PE only | no differentiation | batch ${BATCH_SIZE}/GPU"
echo "[poses] 11 directions from full-circle grid 23 | centers 0 to 156.52 degrees | K24/K12 | 22 real poses + null"
torchrun --standalone --nproc_per_node="${NPROC_PER_NODE}" \
  -m experiments.imagenet100.train_vit \
  --config configs/imagenet100/deit_tiny_rot_hex_harmonic_softmax_pe_half11of23_compact_r7_ddp_e20.json \
