...
NAME="deit_tiny_rot_hex_harmonic_softmax_pe_center_look_half6_compact_r3_imagenet100_ddp_e5"
...
echo "[run] 5 epochs | Hex half6d3r + null-softmax | PE + one shared center angular Look | batch ${BATCH_SIZE}/GPU"
torchrun --standalone --nproc_per_node="${NPROC_PER_NODE}" \
  -m experiments.imagenet100.train_vit \
  --config configs/imagenet100/deit_tiny_rot_hex_harmonic_softmax_pe_center_look_half6_compact_r3_ddp_e5.json \
