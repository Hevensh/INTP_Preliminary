...
NAME="deit_tiny_rot_hex_harmonic_softmax_pe_look_half6_imagenet100_ddp_e5"
...
echo "[run] 5-epoch smoke | Rot-Hex half6/12 null-softmax | PE + Look | batch ${BATCH_SIZE}/GPU"
torchrun --standalone --nproc_per_node="${NPROC_PER_NODE}" \
  -m experiments.imagenet100.train_vit \
  --config configs/imagenet100/deit_tiny_rot_hex_harmonic_softmax_pe_look_half6_ddp_e5.json \
