...
NAME="deit_tiny_rot_hex_harmonic_l1_softmax_pe_imagenet100_ddp_e20"
...
echo "[run] Rot-Hex raw relative L1 harmonic softmax | null -0.1 | PE"
torchrun --standalone --nproc_per_node="${NPROC_PER_NODE}" \
  -m experiments.imagenet100.train_vit \
  --config configs/imagenet100/deit_tiny_rot_hex_harmonic_l1_softmax_pe_ddp_e20.json \
  --data-root "${DATA_ROOT}" \
