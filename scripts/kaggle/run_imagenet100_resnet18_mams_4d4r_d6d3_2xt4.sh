...
EPOCHS="${EPOCHS:-5}"
NAME="${EXPERIMENT_NAME:-resnet18_mams_4d4r_d6d3_imagenet100_ddp_e${EPOCHS}}"
...
echo "[run] MAMS-ResNet-18 | D6/D3 | half4d4r + null-softmax | ${EPOCHS} epochs | batch ${BATCH_SIZE}/GPU"
torchrun --standalone --nproc_per_node="${NPROC_PER_NODE}" \
  -m experiments.imagenet100.train_vit \
  --config configs/imagenet100/resnet18_mams_4d4r_d6d3_ddp_e20.json \
