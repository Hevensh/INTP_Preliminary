...
EPOCHS="${EPOCHS:-20}"
BASE_CONFIG="configs/imagenet100/deit_tiny_rot_hex_harmonic_softmax_pe_look_center_grid_look_share4l_half6_compact_r3_ddp_e20.json"
...
run_share() {
  ...
  local name="deit_tiny_rot_hex_harmonic_softmax_pe_look_center_grid_look_share${layers_per_probe}l_half6_compact_r3_optimized_imagenet100_ddp_e${EPOCHS}"
  ...
  echo "[run] ${EPOCHS} epochs | optimized dual Look | G=${layers_per_probe} | batch ${BATCH_SIZE}/GPU"
