...
EPOCHS="${EPOCHS:-5}"
NAME="${EXPERIMENT_NAME:-resnet18_mixconv4_k3579_imagenet100_ddp_e${EPOCHS}}"
...
echo "[run] ResNet-18 MixConv4 | DW K3/K5/K7/K9 | ${EPOCHS} epochs | batch ${BATCH_SIZE}/GPU"
torchrun --standalone --nproc_per_node="${NPROC_PER_NODE}" \
  -m experiments.imagenet100.train_vit \
  --config configs/imagenet100/resnet18_mixconv4_ddp_e20.json \
