...
NAME="deit_tiny_rot_hex_harmonic_softmax_pe_half7of17_compact_r5_imagenet100_ddp_e20"
...
echo "[run] 20 epochs | 7of17d5r + null-softmax | PE only | no differentiation | batch ${BATCH_SIZE}/GPU"
echo "[poses] 7 directions from full-circle grid 17 | centers 0 to 127.06 degrees | K24/K12 | 14 real poses + null"
torchrun --standalone --nproc_per_node="${NPROC_PER_NODE}" \
  -m experiments.imagenet100.train_vit \
  --config configs/imagenet100/deit_tiny_rot_hex_harmonic_softmax_pe_half7of17_compact_r5_ddp_e20.json \
