...
def build_imagenet100_model(
    *,
    ...
    if variant in {"hex_direction_pyramid", "hex_direction_pyramid_full6"}:
        ...
        return HexDirectionPyramid(image_size=image_size, num_classes=num_classes,
                                   full_circle=variant == 'hex_direction_pyramid_full6')
    ...
    if variant in {
        ...
        return DeiTTinyRotHexLook(
            ...
            image_look_field_direction_bins=image_look_field_direction_bins,
            feature_look_field_direction_bins=feature_look_field_direction_bins,
